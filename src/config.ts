...
//
// This is the SINGLE SOURCE OF TRUTH for all user-facing copy. Every other
// supported locale (ES, CA, FR, ZH) is produced automatically at runtime by
// the dynamic translation layer in src/i18n/translate.ts — there is no
// hand-maintained duplicate of this object per language. Edit only this
// English content; translations regenerate themselves.
//////////////////////////////////////////////////////////////////
